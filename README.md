...
- The Gemini model used is set in `chat_bot.py` — check the [Gemini API docs](https://ai.google.dev/gemini-api/docs/models) for the current list of available model names if you run into a model-not-found error.
